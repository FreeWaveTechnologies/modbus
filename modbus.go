...
const (
	...
	//fcReadWriteMultipleRegisters uint8 = 0x17  // uncomment when supported
	//fcReadFifoQueue              uint8 = 0x18  // uncomment when supported

	// file access
	// fcReadFileRecord             uint8 = 0x14 // uncomment when supported
	// fcWriteFileRecord            uint8 = 0x15 // uncomment when supported
